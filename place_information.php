                        ...
                        <div class="custom-form" >
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="formFileMultiple">Place Images<span class="text-danger">*</span></label>
                                                <input name="placeimages" id="placeimages" type="file" class="form-control" multiple >
                                        </div> 
                                    </div><!--end col-->
