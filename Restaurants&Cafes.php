...
<?php
$sql_query = "SELECT * FROM places WHERE category = '4'";
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            <h4 class="title mb-3">Restaurants & Cafes</h4>
                            <p class="text-muted para-desc mx-auto mb-0">Restaurants & Cafes prepare and serves food and drinks to customers.including a wide variety of cuisines and service models.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
