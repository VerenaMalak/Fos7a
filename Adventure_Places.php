                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        <div class="section-title text-center mb-4 pb-2">
                            <h4 class="title mb-3">Adventure Places</h4>
                            <p class="text-muted para-desc mx-auto mb-0">Adventure Places offering a variety of outdoor entertainments involving physical challenges & often undertaken to create psychological arousal.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
